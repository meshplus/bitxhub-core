...
//	testPubKeys := make([]crypto.PubKey, 0)
//	testPeers := make([]string, 0)
//	for i := 0; i < 4; i++ {
...
//	acceptedShares[conversion.RoundInfo{RoundMsg: "testRound", MsgIdentifier: "123:0"}] = []string{"2", "3"}
//	acceptedShares[conversion.RoundInfo{Index: 1, RoundMsg: "testRound", MsgIdentifier: "123:0"}] = []string{"2"}
...
//	acceptedShares[conversion.RoundInfo{RoundMsg: "testRound", MsgIdentifier: "123:0"}] = []string{"2", "3", "4"}
//	blameMgr.acceptShareLocker.Unlock()
