...
func (m *MockStub) CrossInvokeEVM(address string, input []byte) *boltvm.Response {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CrossInvokeEVM", address, input)
	ret0, _ := ret[0].(*boltvm.Response)
	return ret0
}
...
func (mr *MockStubMockRecorder) CrossInvokeEVM(address, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CrossInvokeEVM", reflect.TypeOf((*MockStub)(nil).CrossInvokeEVM), address, input)
}
